...
import org.first5924.frc2024.constants.LedsConstants;
...
public class Leds extends SubsystemBase {
    private final CANdle m_candle = new CANdle(LedsConstants.CANdleID, "rio");
    ...
    public void CANdleSystem(XboxController joy) {
        this.joystick = joy;
