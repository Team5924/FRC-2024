  ...
  public void execute() {
    switch(elevator.getWristAndElevatorState()) {
      ...
      case AMP:
        ...
        break;
      case AIM_LOW:
        wrist.setAngle(wrist.calculateShootingAngle(WristAndElevatorState.AIM_LOW, drive.getDistanceToSpeakerCenter(RobotContainer.getAlliance())), elevator.getHeightMeters());
        break;
      case AIM_HIGH:
