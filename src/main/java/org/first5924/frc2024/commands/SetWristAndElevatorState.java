...
public class SetWristAndElevatorState extends InstantCommand {
  ...
  private final WristAndElevatorState state;

  public SetWristAndElevatorState(Elevator elevator, WristAndElevatorState state) {
  ...
  public void initialize() {
    elevator.setWristAndElevatorState(state);
  }
}
